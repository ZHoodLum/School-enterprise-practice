...
<head>
	...
	-->
 	<frameset rows="6%,94%" cols="*" frameborder="yes" border="1" framespacing="1">
			...
			<frame src="main1.jsp" name="head" allowTransparency="true" scrolling="no" >

		  <frameset cols="14%,86%" frameborder="yes" framespacing="1">

		  	<frame src="teacherpage.jsp" name="left" allowTransparency="true" scrolling="no" noresize="noresize">
