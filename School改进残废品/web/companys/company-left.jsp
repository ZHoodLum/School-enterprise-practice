    ...
    <div class="leftsidebar_box">
        ...
        <dl class="system_log">
            <dt class="first_dd"><img src="../images/left/select_xl01.png">
                <a href="../companys/addinformation.jsp" target="right">发布招聘信息</a>
            </dt>
        ...
        <dl class="custom">
            <dt><img src="../images/left/select_xl01.png">
                <a href="selectStudentApply.action" target="right">审核实习申请</a>
            </dt>
            <dd class="first_dd"></dd>
            <dd class="first_dd" style="height: 10px;"></dd>
        </dl>
        ...
        <dl class="app">
            <dt><img src="../images/left/select_xl01.png">
                <a href="getAllStudentForEnterPrise.action" target="right">查询学生信息</a>
            </dt>
            <dd class="first_dd"></dd>
            <dd class="first_dd" style="height: 10px;"></dd>
        </dl>
        <dl class="cloud">
            <dt><img src="../images/left/select_xl01.png">
                <a href="../companys/student-score.jsp" target="right">评判学生成绩</a>
            </dt>
            <dd class="first_dd"></dd>
            <dd class="first_dd" style="height: 10px;"></dd>
        </dl>
