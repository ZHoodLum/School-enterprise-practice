        ...
        <div>
            <form id="myform" name="myform" action="***********">
                <table border="0" width="100%"  style="text-align: center;margin-left: 260px;">
                    <tr>
                        <td>
                            <ul>
                                <li id="firtsts">
                                    <h3>教师账号:</h3>
                                    <p><input type="text" name="passwd" placeholder="请填写教师账号，即账号！例如：153200335"/></p>
                                </li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <ul>
                                <li id="threes">
                                    <h3>教师姓名:</h3>
                                    <p><input type="text" name="passwd" placeholder="请填写教师姓名！例如：张三"/></p>
                                </li>
                            </ul>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <ul>
                                <li id="lasts">
                                    <h3>职称:</h3>
                                    <p><input type="text" name="passwd" placeholder="请填写职位！例如：导员"/></p>
                                </li>
                            </ul>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <a href="javascript:;" class="btn" style="float: left;margin-left: 150px;">提交教师信息</a>
                            <input type="reset" name="button" class="btn" value="重置教师信息" style="float: left;margin-left: 100px;">
                        </td>
                    </tr>
